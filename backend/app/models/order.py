...
class Order(Base):
    ...
    cancellation_initiator = Column(String(32), default="", comment="取消发起方: seller/buyer/system")
    cancellation_reason = Column(String(128), default="", comment="取消原因代码")
    cancellation_reason_message = Column(Text, default="", comment="取消原因描述")
